                    ...
                    <tr key={p.id} className="hover:bg-slate-50/80 transition-colors">
                      ...
                      <td className="py-3 px-4 font-mono font-bold whitespace-nowrap">
                        <div className="flex items-center gap-2">
                          <span className="text-[#1D71CB]">{p.productionLot}</span>
                          {p.isInitialInventory ? (
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
                ...
                <div className="space-y-3 pt-4 border-t border-slate-100">
                  ...
                  {selectedProduction.isInitialInventory ? (
                    <div className="p-3 bg-purple-50/70 border border-purple-200 rounded-lg text-xs space-y-1">
                      <div className="flex items-center gap-2 text-purple-900 font-bold">
                        <Layers className="w-3.5 h-3.5 text-purple-600" />
                        <span>Línea Base — Inventario Inicial Físico</span>
                      </div>
                      <p className="text-[11px] text-purple-700">
                        Este lote representa la apertura de stock físico de la planta sin requerir vinculación a materia prima de troza previa.
                      </p>
                    </div>
